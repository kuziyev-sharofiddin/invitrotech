...
{{--                                    <img alt="Logo" src="{{ auth()->user()->image !== null ? asset(auth()->user()->image) : asset('/image/favicon.svg') }}"/>--}}
                                </div>
...
{{--                                        {{auth()->user()->email}}--}}
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ url('admin/account/setting') }}"
                               class="menu-link px-5">{{ __('public.account') }}</a>
                        </div>
                        <div class="menu-item px-5">
                            <a href="/admin/logout" class="menu-link px-5 bg-danger text-white d-flex align-items-center justify-content-center">{{ __('public.logout') }}</a>
                        </div>
                    </div>
                </div>
