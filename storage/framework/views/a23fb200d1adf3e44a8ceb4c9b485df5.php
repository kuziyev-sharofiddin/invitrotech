<?php $__env->startSection( 'title', 'Order Show'); ?>
                    ...
                    <table id="categories_datatable"
                        ...
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="even">
                                ...
                                <td><?php echo e($order->user->customer_name); ?></td>
                                <td><?php echo e($order->user->street_address); ?></td>
                                ...
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            <div>
                                                <a href="<?php echo e(route('order-items',['order'=>$order->id])); ?>"
                                                   class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                                    <i class="bi bi-list p-0"></i>
                                                </a>
                                            </div>
                                            <div>
                                            <form action="<?php echo e(route('order.destroy',['order'=>$order->id])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
