...
<head>
    <base href=""/>
    <title>NordicCell | <?php echo $__env->yieldContent('title'); ?></title>
    <meta charset="utf-8"/>
...
<?php if(session('update_message')): ?>
    ...
    <script>
        ...
        toastr.success("<span style='font-size: 18px;'><?php echo e(session('update_message')); ?></span>");
    </script>
<?php endif; ?>
...
<script>
    $(document).ready(function () {
        ...
        $('#parent-category-dropdown').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('api/categories')); ?>",
                type: "POST",
                data: {
        ...
        $('#category-dropdown').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('api/sub-categories')); ?>",
                type: "POST",
                data: {
        ...
        $('#sub-category-dropdown').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('api/sub-category-items')); ?>",
                type: "POST",
                data: {
...
<?php /**PATH C:\OSPanel\home\nordiccell\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>