                    ...
                    <table id="categories_datatable"
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="even">
                                ...
                                <td><?php echo e($user->director_name); ?></td>
                                <td><?php echo e($user->email); ?></td>
                                <td><div class="text-end">
                                        <div class="btn-group">
                                            <form action="<?php echo e(route('admin.changeStatus', ['id'=>$user->id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <?php if($user->status == 0): ?>
                                                    <input type="hidden" value="0" name="status">
                                                    <button type="submit" class="badge badge-light-danger" style="border: hidden" >InActive</button>
                                                <?php else: ?>
                                                    <input type="hidden" value="1" name="status">
                                                    <button type="submit" class="badge badge-light-success" style="border: hidden">Active</button>
                                                <?php endif; ?>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            <form action="<?php echo e(route('user.destroy', ['user'=> $user->id])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
