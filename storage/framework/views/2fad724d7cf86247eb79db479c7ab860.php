    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('parent_categories.index')); ?>" class="menu-link">
            <span class="menu-icon">
                <i class="ki-duotone ki-home-3 fs-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
            ...
            <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('sub_categories.index')); ?>" class="menu-link">
            <span class="menu-icon">
                <i class="ki-duotone ki-home-3 fs-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('sub_category_items.index')); ?>" class="menu-link">
            <span class="menu-icon">
                <i class="ki-duotone ki-home-3 fs-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
...
<?php /**PATH C:\OSPanel\home\nordiccell\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>