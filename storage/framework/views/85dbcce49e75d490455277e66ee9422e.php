        ...
        <div class="card card-body p-10">
            <div class="d-flex flex-stack mb-5 ">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <a href="<?php echo e(route('sub_category_items.create')); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="table-responsive">
                    <table id="categories_datatable"
                        ...
                        <?php $__currentLoopData = $subCategoryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="even">
                                <td><?php echo e($subCategoryItem->id); ?></td>
                                <td><?php echo e($subCategoryItem->name); ?></td>
                                <td><?php echo e($subCategoryItem->subCategory->name); ?></td>
                                <td><?php echo e($subCategoryItem->status); ?></td>
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('sub_category_items.edit', ['sub_category_item'=> $subCategoryItem->id])); ?>"
                                               class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                                <i class="bi bi-pencil p-0"></i>
                                            </a>
                                            <form action="<?php echo e(route('sub_category_items.destroy', ['sub_category_item' => $subCategoryItem->id])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="categories_datatable_paginate">
                            <?php if($subCategoryItems->hasPages()): ?>
                                <div class="pagination-wrapper">
                                    <?php echo e($subCategoryItems->links()); ?>
