<?php $__env->startSection( 'title', 'Product Images Show'); ?>
        ...
        <div class="card card-body p-10">
            <div class="d-flex flex-stack mb-5 ">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <a href="<?php echo e(route('product_images.show',['product_image'=> $product->id])); ?>" class="btn btn-primary btn-sm">
                    ...
                    <table id="categories_datatable"
                        ...
                        <?php $__currentLoopData = $product_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="even">
                                ...
                                <td class="sorting_1">
                                    <img class=" img-thumbnail w-50px h-50px" src="<?php echo e($product_image->getImageUrl()); ?>"
                                                           alt="photo">
                                </td>
                                <td>
                                    <div class="text-end">
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('product_images.edit', ['product_image'=> $product_image->id])); ?>"
                                               class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                                <i class="bi bi-pencil p-0"></i>
                                            </a>
                                            <form action="<?php echo e(route('product_images.destroy', ['product_image'=> $product_image->id])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="categories_datatable_paginate">
                            <?php if($product_images->hasPages()): ?>
                                <div class="pagination-wrapper">
                                    <?php echo e($product_images->links()); ?>
