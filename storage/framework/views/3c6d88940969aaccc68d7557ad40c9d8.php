            ...
            <div class="app-navbar flex-shrink-0">
                <div class="app-navbar-item ms-1 ms-md-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-auto min-w-200 mw-300px py-3" data-kt-menu="true" style="">
                        <div class="menu-item px-3 ">
                            <a href="/locale/crl" class="menu-link d-flex px-5 <?php if(session()->get('locale') === 'crl'): ?> active <?php endif; ?>">
                        <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/media/flags/uzbekistan.png" alt="">
                        </span>Krill</a>
                        </div>
                        <div class="menu-item px-3 ">
                            <a href="/locale/ru" class="menu-link d-flex px-5 <?php if(session()->get('locale') === 'ru'): ?> active <?php endif; ?>">
                        <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/media/flags/russia.png" alt="">
                        </span>Rus</a>
                        </div>
                        <div class="menu-item px-3 active">
                            <a href="/locale/uz" class="menu-link d-flex px-5 <?php if(session()->get('locale') === 'uz'): ?> active <?php endif; ?>">
                        <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/media/flags/uzbekistan.png" alt="">
                        </span>Uzb</a>
                        </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer w-45px h-45px d-flex align-items-center justify-content-center"
                        ...
                        <img src="\wp-content\uploads\2021\10\cropped-android-chrome-512x512-2-192x192.png"  alt="user" style="width: 55%; margin-top: 6px;"/>
                    </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="<?php echo e(url('admin/account/setting')); ?>"
                               class="menu-link px-5"><?php echo e(__('public.account')); ?></a>
                        </div>
                        <div class="menu-item px-5">
                            <a href="/admin/logout" class="menu-link px-5 bg-danger text-white d-flex align-items-center justify-content-center"><?php echo e(__('public.logout')); ?></a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\OSPanel\home\nordiccell\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>