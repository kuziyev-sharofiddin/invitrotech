                ...
                <div class="col-full">
                    <nav class="woocommerce-breadcrumb">
                        ...
                        <?php if(isset($product->subCategoryItem->name)): ?>
                            <span class="breadcrumb-content"><a
                                    href="<?php echo e(route('sub_category_item.products',['name' => $product->subCategoryItem->name])); ?>"><?php echo e($product->subCategoryItem->name); ?></a></span><span
                                class="breadcrumb-separator"> &gt; </span>
                        <?php endif; ?>
                        <span
                                    ...
                                    <tr id="product-9180"
                                        ...
                                        <td class="woocommerce-grouped-product-list-item__label">
                                            <div class="item-product-children" data-id="9180">
                                                ...
                                                <div class="col-product-title"><label for="product-9180"><?php echo e($detail->color->name); ?></label><span
